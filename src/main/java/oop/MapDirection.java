...
public enum MapDirection {
    ...
    NORTH(0),NORTH_EAST(1),EAST(2),SOUTH_EATS(3),SOUTH(4),SOUTH_WEST(5),WEST(6),NORTH_WEST(7);
    ...
    final private static MapDirection[] dirPositionNr = {NORTH,NORTH_EAST,EAST,SOUTH_EATS,SOUTH,SOUTH_WEST,WEST,NORTH_WEST};
